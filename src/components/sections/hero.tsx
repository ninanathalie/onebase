    ...
    <section className="pt-32 pb-16 md:pt-40 md:pb-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="px-4 py-10 md:py-20">
          <h1 className="relative z-10 mx-auto max-w-2xl lg:max-w-6xl text-center font-semibold text-slate-900 text-4xl lg:text-7xl xl:text-8xl">
          ...
          <motion.div
            ...
            className="relative z-10 mt-20 rounded-3xl border bg-slate-900 p-2 lg:p-4 shadow-md"
          >
