...
const SectionTitle: React.FC<SectionTitleProps> = ({ title, subtitle, description, centered = false, responsive = false, mode = "light", className }) => {
  const isDark = mode === "dark";

  const alignmentClass = responsive ? "text-center lg:text-left" : centered ? "text-center" : "text-left";

  return (
    <div className={`${alignmentClass} ${className} mb-12`}>
